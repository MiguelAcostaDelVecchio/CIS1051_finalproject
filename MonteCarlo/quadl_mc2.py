# Working with quandl is very problematic due to the API speed limit of calls per day
# I will not work on this code, instead I will create my own Monte Carlo simulation that uses yfinance
...
prices = quandl.get(stock_name,
                authtoken=quandl.ApiConfig.api_key,
...
scen_size = 50 # Number of simulations
...
# Dataframe format for predictions
Preds_df = pd.DataFrame(S.swapaxes(0, 1)[:, :scen_size]).set_index(
